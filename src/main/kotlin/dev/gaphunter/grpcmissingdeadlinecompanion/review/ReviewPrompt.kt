package dev.gaphunter.grpcmissingdeadlinecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.grpcmissingdeadlinecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.grpcmissingdeadlinecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "gRPC Missing Deadline Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34005-grpc-missing-deadline-companion/reviews"
